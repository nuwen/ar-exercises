...
whistler = Store.create(name: "Whislter", annual_revenue: 1900000, mens_apparel: true, womens_apparel: false)
...
@womens_stores.each {|store| puts "#{store.name} | #{store.annual_revenue} | #{store.womens_apparel}"}
